			<div class="<!-- IF children.class -->{children.class}<!-- ELSE -->col-md-3 col-sm-6 col-xs-12<!-- ENDIF children.class --> category-item" data-cid="{children.cid}" data-numRecentReplies="{children.numRecentReplies}">
				...
				<div class="category-icon">
					...
					<!-- ELSE -->
					<a style="color: {children.color};" href="{config.config.relative_path}/category/{children.slug}" itemprop="url">
					<!-- ENDIF children.link -->
						<div
					...
					<div class="category-box">
						<div class="category-info">
							...
							<!-- ELSE -->
							<a href="{config.config.relative_path}/category/{children.slug}" itemprop="url">
							<!-- ENDIF children.link-->
						...
						<div class="post-preview clearfix">
							<div class="post-preview-content">
								<strong><a href="{config.config.relative_path}/topic/{children.posts.topic.slug}">{children.posts.topic.title}</a></strong>
								<hr/>
								<a style="color: {children.color};" href="<!-- IF children.posts.user.userslug -->{config.config.relative_path}/user/{children.posts.user.userslug}<!-- ELSE -->#<!-- ENDIF children.posts.user.userslug-->">
							...
							<span class="pull-right post-preview-footer">
								...
								<a href="{config.config.relative_path}/topic/{children.posts.topic.slug}<!-- IF children.posts.index -->/{children.posts.index}<!-- ENDIF children.posts.index -->">[[global:read_more]]</a>
							</span>
						</div>
						<!-- END posts -->
						<!-- ENDIF !children.link -->
