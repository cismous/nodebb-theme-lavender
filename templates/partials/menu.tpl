            <div class="navbar-header">
                ...
                <div>
                    <a href="{config.config.relative_path}/">
            ...
            <div class="navbar-collapse collapse navbar-ex1-collapse" id="nav-dropdown">
                ...
                <ul id="main-nav" class="nav navbar-nav pull-left">
                    ...
                    <li class="{navigation.class}">
                        <a href="{config.config.relative_path}{navigation.route}" title="{navigation.title}" id="{navigation.id}" target="{navigation.properties.target}">
                ...
                <ul id="logged-in-menu" class="nav navbar-nav navbar-right pull-right">
                    <li class="notifications dropdown text-center hidden-xs">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="notif_dropdown">
                            ...
                            <li class="notif-dropdown-link"><a href="{config.config.relative_path}/notifications">[[notifications:see_all]]</a></li>
                        </ul>
                    </li>

                    <!-- IF searchEnabled -->
                    <li class="visible-xs">
                        <a href="{config.config.relative_path}/search">
                    ...
                    <li class="visible-xs">
                        <a href="{config.config.relative_path}/notifications" title="[[notifications:title]]">
                    ...
                    <li class="chats dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="chat_dropdown">
                            ...
                            <li class="notif-dropdown-link"><a href="{config.config.relative_path}/chats">[[modules:chat.see_all]]</a></li>
                        </ul>
                    </li>
                    <!-- ENDIF !disableChat -->
                    ...
                    <li id="user_label" class="dropdown">
                        ...
                        <ul id="user-control-list" class="dropdown-menu" aria-labelledby="user_dropdown">
                            <li>
                                <a id="user-profile-link" href="{config.config.relative_path}/user/{user.userslug}">
                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    <li>
                        <a href="{config.config.relative_path}/login">
