...
<div class="row">
	<div class="{register_window:spansize}">
		<div class="well well-lg">
			...
			<form class="form-horizontal" role="form" action="{config.config.relative_path}/register" method="post">
	...
	<div class="col-md-6">
		<div class="well well-lg">
			...
			<ul class="alt-logins">
				...
				<li class="{authentication.name}"><a rel="nofollow" target="_top" href="{config.config.relative_path}{authentication.url}"><i class="fa {authentication.icon} fa-3x"></i></i></a></li>
				<!-- END authentication -->
			</ul>
		</div>
	</div>
